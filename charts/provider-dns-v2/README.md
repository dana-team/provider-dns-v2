...
A Helm chart for Crossplane provider-dns-v2.

## Values

| Key | Type | Default | Description |
|-----|------|---------|-------------|
| clusterProviderConfig | object | `{"credentials":{"secretRef":{"key":"credentials","name":"dns-creds","namespace":"crossplane-system"},"source":"Secret"},"name":"default"}` | ClusterProviderConfig authentication configuration |
| deploymentRuntimeConfig | object | `{"container":{"args":["--debug"],"name":"package-runtime","volumeMounts":{"mountPath":"/etc/krb5.conf","name":"krb5-config","readOnly":true,"subPath":"krb5.conf"}},"dnsConfig":{"nameservers":["8.8.8.8"]},"dnsPolicy":"ClusterFirst","name":"dns-config-v2","volumes":{"configMap":{"name":"krb5-config"},"name":"krb5-config"}}` | Configuration to be added to the provider deployment via the DeploymentRuntimeConfig resource |
| deploymentRuntimeConfig.dnsPolicy | string | `"ClusterFirst"` | Optional DNS fields for local development |
| fullnameOverride | string | `""` |  |
| image.repository | string | `"ghcr.io/dana-team/provider-dns-v2"` | The repository of the provider container image. |
...
| nameOverride | string | `""` |  |
| provider.name | string | `"provider-dns-v2"` | Name of the provider |
| provider.runtimeConfigRef.name | string | `"dns-config-v2"` | Name of the DeploymentRuntimeConfig object to use |
